...
try:
    ...
    goto_position(copter, point_dict['경영본관'], groundspeed=8)
    time.sleep(2)
    
    print("Star maneuver begins")
    for i in range(5):
        goto_position_target_local_ned(copter, -16.18034, -11.75571, 0)
        time.sleep(15)
        print("done", i)

    print("Star maneuver ends\n\n")
